  ...
  return (
    <div className="bg-grid mx-auto max-w-6xl space-y-8 px-4 py-10">
      ...
      <div className="flex flex-wrap items-center gap-2 text-xs text-muted">
        ...
        <span>·</span>
        <span>{source === "stake-api" ? "Live thumbs from Stake" : "Static catalog"}</span>
        <span>·</span>
      ...
      <div className="flex flex-wrap gap-2">
        {(
          [
            ...
            ["all", "All", slots.length + table.length + instant.length, Gamepad2],
          ] as const
      ...
      {tab === "slots" && (
        <Card className="border-accent/25 bg-accent/5">
          <CardContent className="flex flex-col gap-3 p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="font-semibold text-accent">Thousands of provider slots</div>
