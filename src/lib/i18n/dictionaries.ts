...
const en = {
  ...
  auth: {
    ...
    invalid creds: "Invalid email or password",
...
const fr: Dictionary = {
  ...
  disclaimer:
    "À des fins de divertissement seulement. Les paris comportent des risques. Les résultats passés ne garantissent pas les résultats futurs. Vous devez avoir 18 ans et + / 21 ans et + (selon la juridiction) pour utiliser des services de paris sportifs. Pariez de façon responsable.",
  footer: {
